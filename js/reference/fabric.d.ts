declare namespace fabric {
    ...
    class StaticCanvas {
         ...
         */
        static supports(
            methodName: 'getImageData' | 'toDataURL' | 'toDataURLWithQuality' | 'setLineDash',
        ): boolean;

        /**
         *  canvas element to a dataurl image. Note that when multiplier is used, cropping is scaled appropriately
         * @param [options] Options object
         */
    ...
    interface IObjectOptions {
        ...
        /**
         * When `true`, object is not d in OBJECT/JSON
         * since 1.6.3
         * @default
         */
        excludeFrom?: boolean | undefined;
    ...
    class Object {
        ...
        // -----------------------------------------------------------------------------------------------------------------------------------
        /**
         * Returns styles-string for svg-         * @param {Boolean} skipShadow a boolean to skip shadow filter output
         * @return {String}
         */
        getSvgStyles(skipShadow?: boolean): string;
        /**
         * Returns transform-string for svg-         * @param {Boolean} use the full transform or the single object one.
         * @return {String}
         */
        ...
        getSvgFilter(): string;
        /**
         * Returns styles-string for svg-         * @param {Object} style the object from which to retrieve style properties
         * @param {Boolean} useWhiteSpace a boolean to include an additional attribute in the style.
         * @return {String}
         */
        getSvgSpanStyles(style: any, useWhiteSpace?: boolean): string;
        /**
         * Returns text-decoration property for svg-         * @param {Object} style the object from which to retrieve style properties
         * @return {String}
         */
    ...
    let filterBackend: FilterBackend | undefined;
