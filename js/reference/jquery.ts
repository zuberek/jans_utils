...
interface JQuery {
    ...
    attr(
        ...
        func: (this: HTMLElement, index: number, attr: string) => string | number,
    ): JQuery;
    /**
     * Set one or more attributes for the set of matched elements.
     *
    ...
    contextmenu(
        eventData: Object,
        handler: (this: HTMLElement, eventObject: JQueryMouseEventObject) => any,
    ): JQuery;
     ...
     */
    after(
        func: (this: HTMLElement, index: number, html: string) => string | Element | JQuery,
    ): JQuery;
